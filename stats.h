...
private:
	void setupSumHuex(PNG & img);

	void setupSumHuey(PNG & img);

	void setupSumSat(PNG & img);

	void setupSumLum(PNG & img);

	void setupHist(PNG & img);

	void putintobuckets(PNG & img, int x, int y, int bucket);
};
